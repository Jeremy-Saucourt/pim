function [ matTransfert, matDiffrac ] = mTransfertDiscretMailleCarrePlotCarre( gamma, beta2, Nd, pitch, w0, lambda, foc, dphi )
% mTransfertDiscretMailleCarrePlotCarre : Calcul de la matrice de transfert
% d'un système à contraste de phase d'un champ proche en maille carrée,
% pour un filtre de plot déphasant carré
%
...
%% Matrice de couplage diffractif
    diamLobCentr = 2*lambda*foc/((Nd-1)*pitch+2*w0) ; 
